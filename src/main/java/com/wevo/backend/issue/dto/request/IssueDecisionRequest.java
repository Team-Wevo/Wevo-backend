...
import com.wevo.backend.global.validation.NonWhitespaceSize;
...
public record IssueDecisionRequest(
        @Size(max = SynthesisIssueContract.MAX_OPTION_TEXT_LENGTH)
        String selectedOption,
        @NonWhitespaceSize(max = IssueDecision.MAX_CUSTOM_INPUT_LENGTH)
        String customInput
) {
