...
public enum ErrorCode {
    ...
    OAUTH_INVALID_AUTHORIZATION_CODE(HttpStatus.BAD_REQUEST, "A008", "유효하지 않은 인가코드입니다. 다시 로그인해주세요."),
    ...
    AI_INPUT_BUDGET_EXCEEDED(HttpStatus.UNPROCESSABLE_ENTITY, "AI031",
            "AI 입력이 처리 가능한 크기를 초과했습니다. 입력을 줄여주세요."),
